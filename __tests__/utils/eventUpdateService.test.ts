...
describe('Event Update Service with Tracking Tests', () => {
  ...
  const mockExistingEvent = {
    ...
    endDateTime: new Date('2025-08-15T14:00:00Z'),
    ageRequired: '18+',
  ...
  const mockNewEvent = {
    ...
    eventType: 'RPG',
    gameSystem: 'D&D',
    startDateTime: new Date('2025-08-15T11:00:00Z'), // Time changed
    endDateTime: new Date('2025-08-15T15:00:00Z'),
    ageRequired: '18+',
    experienceRequired: 'None',
    materialsRequired: 'None',
  ...
  describe('Event change detection and notifications', () => {
    it('should detect changes and send notifications to tracking users', async () => {
      ...
      expect(mockEventsUpdate).toHaveBeenCalledWith({
        ...
        data: {
          ...
          eventType: 'RPG',
          gameSystem: 'D&D',
          startDateTime: new Date('2025-08-15T11:00:00Z'),
          endDateTime: new Date('2025-08-15T15:00:00Z'),
          ageRequired: '18+',
          experienceRequired: 'None',
          materialsRequired: 'None',
    ...
    it('should create new events without notifications', async () => {
      const newEvent = {
        ...
        eventType: 'TCG',
        gameSystem: 'Magic',
        startDateTime: new Date('2025-08-16T10:00:00Z'),
        endDateTime: new Date('2025-08-16T14:00:00Z'),
        ageRequired: '13+',
